...
export default async function HomePage() {
  ...
  const leaders = [
    { name: "Akshay Dr", role: "Managing Director", desc: "Expert in strategy and institutional trading mentorship.", image: "/images/team/manager_akshay.png" },
    { name: "Akash Dr", role: "Director", desc: "Specialist in technical analysis and market algorithms.", image: "/images/team/manager_akash.png" },
    { name: "Anoop Gangan", role: "Director", desc: "Connecting aspiring traders with high-quality education.", image: "/images/team/manager_anoop.png" },
    { name: "Dev Nair", role: "Director", desc: "Driving ITTA's growth and operational excellence.", image: "/images/team/manager_dev.png" },
  ];
