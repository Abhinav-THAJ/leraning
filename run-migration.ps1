# run-migration.ps1
# Copies the full schema SQL to your clipboard and opens Supabase SQL Editor
# Just paste (Ctrl+V) and click Run!
...
Write-Host "  ITTA Academy - Database Setup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "  1. The browser will open to your SQL editor" -ForegroundColor White
Write-Host "  2. Click in the editor area" -ForegroundColor White
...
Write-Host ""
Write-Host "  After running, visit:" -ForegroundColor White
Write-Host "  http://localhost:3000/courses/export-import-certificate" -ForegroundColor Cyan
Write-Host ""

Start-Process "https://supabase.com/dashboard/project/kiebjlvcmntulmddhkrm/sql/new"
